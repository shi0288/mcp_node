...
Table.prototype.update = function (condition, data, option, cb) {
    ...
    if (self.db.type == prop.dbType.mongodb) {
        ...
        if(self.colList["update_time"] != undefined){
            sql+=",update_time='"+moment().format("YYYY-MM-DD HH:mm:ss")+"'";
        }
        if(self.colList["updateTime"] != undefined){
            sql+=",updateTime='"+moment().format("YYYY-MM-DD HH:mm:ss")+"'";
        }
