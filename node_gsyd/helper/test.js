...
//loanObj.rhday=30;
//loanObj.final_time=new Date("2016-10-25");
//loanObj.accrue_time=new Date("2016-10-22");
...
//0.00 	2月25日	出借本金
    ...
    loanObj.rhday=30;
    loanObj.final_time=new Date("2016-10-21");
    loanObj.accrue_time=new Date("2016-10-02");
    calculateService.outRhjfAyfx(loanObj,500*100);