...
DbCenter.prototype._initMain = function (cb) {
    ...
    var loan = new Table(db, "loan", [
        ...
        new Column(db, "trail_time", "date", -1, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "start_time", "date", -1, false, undefined),
        new Column(db, "rhday", "int", -1, false, undefined)
    ]);
    db.put(loan);

    var loan_info = new Table(db, "loan_info", [
        ...
        new Column(db, "usages", "varchar", 50, false, undefined),
        new Column(db, "address", "varchar", 50, false, undefined),
        new Column(db, "ensure", "varchar", 50, false, undefined),
        new Column(db, "reserve_a", "varchar", 50, false, undefined),
        new Column(db, "reserve_b", "varchar", 50, false, undefined),
        new Column(db, "reserve_c", "varchar", 50, false, undefined),
        new Column(db, "reserve_d", "varchar", 50, false, undefined),
        new Column(db, "reserve_e", "varchar", 50, false, undefined),
        new Column(db, "reserve_f", "varchar", 50, false, undefined)
    ]);
    db.put(loan_info);

    var pledge = new Table(db, "pledge", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "url", "varchar", 200, false, undefined),
        new Column(db, "loan_id", "varchar", 32, false, undefined),
    ...
    var invest = new Table(db, "invest", [
        ...
        new Column(db, "freezeTrxId", "varchar", 32, false, undefined)
    ]);
    db.put(invest);
    ...
    var user = new Table(db, "user", [
        ...
        new Column(db, "chinapnr", "varchar", 32, false, undefined),
        new Column(db, "assessLevel", "varchar", 10, false, undefined),
        new Column(db, "loginTime", "date", -1, false, undefined),
    ...
    var person_info = new Table(db, "person_info", [
        ...
        new Column(db, "work_year", "varchar", 10, false, undefined),
        new Column(db, "age", "varchar", 5, false, undefined),
        ...
        new Column(db, "crime", "int", -1, false, undefined),
    ...
    var person_work = new Table(db, "person_work", [
        ...
        new Column(db, "credit_card", "int", -1, false, undefined),
        new Column(db, "other_card", "int", -1, false, undefined),
        new Column(db, "credit_card_max", "varchar", 32, false, undefined),
        new Column(db, "other_card_des", "varchar", 32, false, undefined),
        new Column(db, "address", "varchar", 32, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "update_time", "date", -1, false, undefined)
    ]);
    ...
    var credit_trail = new Table(db, "credit_trail", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "user_id", "varchar", 32, false, undefined, true, false),
        new Column(db, "level", "varchar", 5, false, undefined),
        new Column(db, "card", "int", -1, false, undefined),
        new Column(db, "bank", "int", -1, false, undefined),
        new Column(db, "work", "int", -1, false, undefined),
        new Column(db, "wages", "int", -1, false, undefined),
        new Column(db, "home", "int", -1, false, undefined),
        new Column(db, "house", "int", -1, false, undefined),
        new Column(db, "car", "int", -1, false, undefined),
        new Column(db, "study", "int", -1, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "update_time", "date", -1, false, undefined)
    ]);
    db.put(credit_trail);
    ...
    var ca_person = new Table(db, "ca_person", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "user_id", "varchar", 32, false, undefined),
        new Column(db, "customer", "varchar", 32, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "update_time", "date", -1, false, undefined)
    ]);
    db.put(ca_person);

    var annexed = new Table(db, "annexed", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "user_id", "varchar", 32, false, undefined),
        new Column(db, "invest_id", "varchar", 32, false, undefined),
        new Column(db, "download_url", "varchar", 1000, false, undefined),
        new Column(db, "viewpdf_url", "varchar", 1000, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "status", "int", -1, false, undefined)
    ]);
    db.put(annexed);
    ...
    var coupon = new Table(db, "coupon", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "name", "varchar", 32, false, undefined),
        new Column(db, "type", "varchar", 32, false, undefined),
        new Column(db, "cond", "varchar", 500, false, undefined),
        new Column(db, "money", "int", -1, false, undefined),
        new Column(db, "start_time", "date", -1, false, undefined),
        new Column(db, "end_time", "date", -1, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
        new Column(db, "num", "int", -1, false, undefined),
        new Column(db, "status", "int", -1, false, undefined),
        new Column(db, "user_cond", "varchar", 500, false, undefined),
        new Column(db, "description", "varchar", 500, false, undefined)
    ]);
    db.put(coupon);

    var my_coupon = new Table(db, "my_coupon", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "coupon_id", "varchar", 32, false, undefined),
        new Column(db, "user_id", "varchar", 32, false, undefined),
        new Column(db, "invest_id", "varchar", 32, false, undefined),
        new Column(db, "update_time", "date", -1, false, undefined),
        new Column(db, "create_time", "date", -1, false, undefined),
