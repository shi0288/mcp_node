 ...
 * 债权价值
 */
CreditorCalculateService.prototype.creditorValueYcxh = function (curRepayDay, curDay, ycxhAccurDate, money, interest) {
    console.log("一次性还本付息债权价值的参数列表为：" + money + "-----" + curRepayDay + "----" + curDay + "----" + ycxhAccurDate + "----" + interest);
    console.log(money + "*******" + (dateMathUtil.daysBetween(curDay, ycxhAccurDate) - 1) + "*******" + (dateMathUtil.daysBetween(curRepayDay, ycxhAccurDate)));
    return creditorDateUtil.twoPrecise(money + (dateMathUtil.daysBetween(curDay, ycxhAccurDate) - 1)/(dateMathUtil.daysBetween(curRepayDay, ycxhAccurDate)
        )*interest);
};
