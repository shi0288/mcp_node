 ...
 *            资金转移的详述
 */
UserBillService.prototype.frozenCouponMoney = function (userId, curMoney, payType, description, cb) {
    var userTab = dc.main.get('user');
    userTab.findOne({id: userId}, {}, [], function (err, user) {
        var accountTab = dc.main.get('account');
        accountTab.findOne({user_id: userId}, {money: 1, frozen_money: 1}, [], function (err, account) {
 ...
 *            资金转移的详述
 */
UserBillService.prototype.thawCouponMoney = function (userId, curMoney, payType, description, cb) {
    var userTab = dc.main.get('user');
    userTab.findOne({id: userId}, {}, [], function (err, user) {
        var accountTab = dc.main.get('account');
        accountTab.findOne({user_id: userId}, {money: 1, frozen_money: 1}, [], function (err, account) {
            ...
            var money = account.money;
            var cond = {};
            cond.transType = userBillCons.transType.THAW;
            cond.payType = payType;
            cond.description = description;
            cond.money = curMoney;
            cond.proMoney = account.money;
 ...
 *            资金转移的详述
 */
UserBillService.prototype.thawMoney = function (userId, curMoney, payType, description, cb) {
    var userTab = dc.main.get('user');
    userTab.findOne({id: userId}, {}, [], function (err, user) {
        var accountTab = dc.main.get('account');
        accountTab.findOne({user_id: userId}, {money: 1, frozen_money: 1}, [], function (err, account) {
