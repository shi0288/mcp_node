 ...
 * @param cb
 */
YcxhOutEngine.prototype.start = function (loanObj, repayTypeObj, cb) {
    var self = this;
...
YcxhOutEngine.prototype.pt = function (loanObj, repayTypeObj, jt, cb) {
    ...
    cursor.count(function (err, count) {
        ...
        var hadInvest = 0;
        //还款日期
        var repay_day = loanObj.final_time;
...
YcxhOutEngine.prototype.ptx = function (loanObj, repayTypeObj, jt, cb) {
    var investTab = dc.main.get('invest');
    var cursor = investTab.find({loan_id: loanObj.id,status:investCons.bid_success}, {}, []).sort({create_time: 1});
    cursor.dateToString();
    cursor.count(function (err, count) {
...
var ycxhOutEngine = new YcxhOutEngine();
module.exports = ycxhOutEngine;